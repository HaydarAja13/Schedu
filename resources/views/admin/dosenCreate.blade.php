    ...
    <x-slot name="title">
        <div class="flex justify-between">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-800 font-righteous">Buat Data Dosen</h1>
            </div>
        </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="nama_dosen" placeholder="Nama lengkap" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" required>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">NIM<span class="text-red-500">*</span></label>
                                <input type="text" name="nip" placeholder="43323019" class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" required>
                            </div>
                        </div>
                    </div>
