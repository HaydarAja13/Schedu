...
=======
<x-template :role="'admin'" title="Edit Kelompok Prodi ">
    <x-slot:content>
        <div class="overflow-scroll h-[calc(100vh-200px)]">
            <form action="{{ route('kelompok-prodi.update', $id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mt-4 bg-white rounded-lg p-8">
                    <div class="grid grid-cols-1 items-center md:grid-cols-3 gap-4 mb-4">
                        ...
                        <input type="text" name="nama_kelompok_prodi" required value="{{ $kelompokProdi->nama_kelompok_prodi }}"
