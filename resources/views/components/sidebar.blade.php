...
<div class="h-screen md:p-4" x-show="open" x-transition>
	...
	<div
        ...
        {{-- relative untuk bisa menggunakan z-index pada anaknya --}}
        {{-- z-40: Membuat bagian ini di atas gambar background, sama dengan konten menu di atas --}}
        <div class="relative inset-x-0 bottom-0 grid place-content-center w-full z-40 bg-transparent">
            {{-- Gambar pemanis, posisikan relatif ke parent ini --}}
            {{-- z-0: Memastikan gambar ini di belakang teks "Powered By" --}}
            <img src="{{ asset('images/sidebar-logo.svg') }}" alt="Pemanis Sidebar" class="absolute bottom-10 left-1/2 -translate-x-1/2 h-24 w-auto z-0"> {{-- bottom-0, left-1/2, -translate-x-1/2 untuk centering --}}

            <hr class="h-0.5 my-2 bg-[#6317DA] border-none relative z-10"> {{-- z-10 agar di atas gambar --}}
            <p class="text-center w-full text-white text-xs mb-3 relative z-10">Powered By <b>TI-2A III</b>.</p> {{-- z-10 agar di atas gambar --}}
        </div>
    </div>
</div>