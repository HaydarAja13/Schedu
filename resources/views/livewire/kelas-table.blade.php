<div x-data="{ selectedRow: null }">
    <x-table-properties :subtitle="'Data Kelas'" link="/kelas/create"></x-table-properties>
            ...
            <table class="min-w-full divide-y-2 divide-gray-200">
                <thead class="ltr:text-left rtl:text-right sticky top-0 bg-white z-10 shadow-sm">
                    <tr class="*:font-medium *:text-gray-900">
                        ...
                        <th class="px-3 py-2 whitespace-nowrap hover:cursor-pointer" wire:click="setSortBy('nama_kelas')">
                            Nama Kelas
                        </th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    @foreach ($kelas as $data)
                        <tr class="cursor-pointer *:text-gray-900 *:first:font-medium transition-all duration-200 hover:bg-gray-200">
                            ...
                            <td class="px-3 py-2 whitespace-nowrap">{{ $data->nama_kelas }}</td>
                            <td class="px-3 py-2 whitespace-nowrap flex gap-2">
                                ...
                                <a href="{{ route('kelas.edit', $data->id) }}"
                                    ...
                                    Edit
                                    <!-- Icon Edit di kanan -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <ul class="flex justify-end gap-1 text-gray-900">
                    <li>
                        <button type="button"
                            ...
                            @if ($kelas->onFirstPage()) disabled @endif>
                    ...
                    <li>
                        <button type="button"
                            ...
                            @if ($kelas->currentPage() == $kelas->lastPage()) disabled @endif>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
