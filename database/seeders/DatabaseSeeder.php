...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        // Kelompok Prodi
        // Jurusan
        DB::table('kelompok_prodi')->insert([
            [
                'nama_kelompok_prodi' => 'Informatika',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'nama_kelompok_prodi' => 'Telekomunikasi',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'nama_kelompok_prodi' => 'Elektronika',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'nama_kelompok_prodi' => 'Listrik',
                'created_at' => $now,
                'updated_at' => $now,
            ],
        ]);
